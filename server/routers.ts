  ...
  carousel: router({
    ...
    create: customAdminProcedure
      .input(z.object({
        ...
        card1Label: z.string().optional(), card1Video: z.string().optional(), card1Link: z.string().optional(),
        card2Label: z.string().optional(), card2Video: z.string().optional(), card2Link: z.string().optional(),
        card3Label: z.string().optional(), card3Video: z.string().optional(), card3Link: z.string().optional(),
        card4Label: z.string().optional(), card4Video: z.string().optional(), card4Link: z.string().optional(),
